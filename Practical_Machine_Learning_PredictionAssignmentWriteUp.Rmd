...
## working on the assignment
 ...
 I analyzed  and interpreted the provided data to determine what activity an individual perform. To do this I made use of the necessary packages , this allowed me to generate correct answers for each of the 20 test data cases provided in this assignment. 
...
you must load the data ( training and test) and clean the data
...
```
 ...
 cast all columns of  8 to the end to be numeric.
